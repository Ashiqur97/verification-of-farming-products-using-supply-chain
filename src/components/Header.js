...
import { FaFileDownload, FaTimes, FaCheckCircle, FaCertificate, FaWallet } from 'react-icons/fa';
import { useBlockchain } from './BlockchainContext';

const Header = () => {
  const { account, networkId, switchToLocalNetwork } = useBlockchain();
      ...
      <header className="bg-white shadow p-4 flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          <div className="flex items-center">
            {account ? (
              <div className="flex items-center">
                <span className={`inline-block w-3 h-3 rounded-full mr-2 ${isCorrectNetwork ? 'bg-green-500' : 'bg-yellow-500'}`}></span>
